...
import { initShareUI, decodeCode } from "./share.js";
...
════════════════════════════════════════════════ */
function saveCode()     { if (editor) localStorage.setItem("pyrun-code", editor.getValue()); }
function getSavedCode() { return localStorage.getItem("pyrun-code"); }

function loadPreferences() {
  const ct = localStorage.getItem("pyrun-color-theme")  || "dark-ocean";
  const et = localStorage.getItem("pyrun-editor-theme") || "dracula";
  const fs = localStorage.getItem("pyrun-font-size")    || "14";
...
async function boot() {
  ...
  applyEditorTheme(localStorage.getItem("pyrun-editor-theme") || "dracula");
  applyFontSize(localStorage.getItem("pyrun-font-size")       || "14");
